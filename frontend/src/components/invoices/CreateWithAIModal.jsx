...
const CreateWithAIModal = ({ isOpen, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      onClose();
      // ✅ Fix: pass aiData inside { state: {} } so location.state?.aiData works in CreateInvoice
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto ">
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        {/* ✅ Fix: onClose (capital C) instead of onclose */}
        <div
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative  text-left transform transition-all">
          ...
          <div className="space-y-4 ">
            <p className="text-sm text-slate-600">
              ...
              items, quantitities,and prices) and the AI will attempt to create
              an invoice for you. The more details you provide, the better the
              AI can generate an accurate invoice.
            </p>
            <TextareaField
              name="invoiceText"
