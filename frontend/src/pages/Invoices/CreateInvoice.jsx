    ...
    if (aiData) {
      setFormData((prev) => ({
        ...
        billTo: {
          ...
          email: aiData.email || "", // ✅ Fix: was aiData.clientEmail
          address: aiData.address || "", // ✅ Fix: was aiData.clientAddress
          phone: "",
        },
                ...
                <tr key={index} className="hover:bg-slate-50">
                  <td className="px-2 sm:px-6 py-4">
                    <input
                      ...
                      className="w-full h-10 px-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-blue-500"
