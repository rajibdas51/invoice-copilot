    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center bg-slate-50 rounded-lg">
        ...
        <p className="text-slate-500 mb-6">
          The requested invoice could not be found or could not be loaded.
        </p>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start pb-8 border-b border-slate-200">
            ...
            <div className="">
              ...
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${invoice.status === "Paid" ? "bg-emerlad-100 text-emerald-800" : invoice.status === "Pending" ? "bg-amber-100 text-amber-800" : "bg-red-100 text-red-800"}
                `}
              >
                {invoice.status}
              </span>
          ...
          <div className="flex justify-end mt-8">
            <div className="w-full max-w-sm space-y-3">
              ...
              <div className="flex justify-between font-semibold text-lg text-slate-900 border-t border-slate-200 pt-2">
                <span>Total</span>
