...
const ProfilePage = () => {
  ...
  return (
    <div className="bg-white p-6 border-slate-200 rounded-lg shadow-sm overflow-hidden max-w-4xl mx-auto">
          ...
          <div>
            ...
            <div className="relative ">
              ...
              <input
                ...
                value={user?.email || ""}
                disabled
                className="w-full h-10 pl-10 pr-3 border border-slate-200 rounded-lg bg-slate-50 text-slate-500 disabled:cursor-not-allowed"
              />
            </div>
          </div>
